...
using AXAMansard.Framework.AuditTrail.Attributes;
using AXAMansard.Framework.DTO;
using AXAMansard.Framework.AuditTrail.Exceptions;
using System.Reflection;
using AXAMansard.Framework.AuditTrail.DTO;

namespace AXAMansard.Framework.AuditTrail
{
    public class AuditTrailInterceptor2 : IInterceptor
    {
        ...
        private List<AuditTrail.DTO.AuditTrail> _inserts = new List<AXAMansard.Framework.AuditTrail.DTO.AuditTrail>();
        private List<AuditTrail.DTO.AuditTrail> _updates = new List<AXAMansard.Framework.AuditTrail.DTO.AuditTrail>();
        private List<AuditTrail.DTO.AuditTrail> _deletes = new List<AXAMansard.Framework.AuditTrail.DTO.AuditTrail>();
        ...
        public bool OnFlushDirty(object entity, object id, object[] currentState, object[] previousState, string[] propertyNames, NHibernate.Type.IType[] types)
        {
            ...
            if (trailable.Length > 0)
            {
                ...
                byte[] newObjectBytes = AXAMansard.Framework.Utility.BinarySerializer.SerializeObject(entity);
                object newObject = AXAMansard.Framework.Utility.BinarySerializer.DeSerializeObject(newObjectBytes);
        ...
        {
            AuditTrail.DTO.AuditTrail trail = new AXAMansard.Framework.AuditTrail.DTO.AuditTrail();
            ...
            if (action != AXAMansard.Framework.AuditTrail.Enums.AuditAction.CREATE)
            {
            ...
            if (!trail.Object.IsASystemChange)
            {
                ...
                try
                {
                    ...
                    {
                        trail.ClientIPAddress = AXAMansard.Framework.Utility.IPResolver.GetIP4Address(true); //IP Address of the host computer.
            ...
            try
            {
                ...
                else
                {
                    ...
                    trail.DataType = AXAMansard.Framework.Utility.EnumBinder.SplitAtCapitalLetters(trail.DataType);
                    ...
                    if (pInfo != null)
                    {
                        ...
                        if (identifier != null)
                        {
                            ...
                            {
                                trail.SubjectIdentifier = AXAMansard.Framework.Utility.EnumBinder.SplitAtCapitalLetters(identifier.ToString());
