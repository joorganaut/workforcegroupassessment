...
using AXAMansard.Framework.NHibernateManager;
...
using AXAMansard.Framework.AuditTrail.DTO;
using System.Web.Security;
using AXAMansard.Framework.Utility;
using System.Threading.Tasks;

namespace AXAMansard.Framework.DAO
{
    public class CoreDAO<T, idT> where T : class, IDataObject 
    {
        ...
        /// </summary>
        /// <param name="obj">The obj.</param>
        public async static Task UpdateAsync(T obj, DatabaseSource dbSource)
        {
            await UpdateAsync(obj, dbSource, false);
        ...
        /// </summary>
        /// <param name="obj">The obj.</param>
        public async static Task UpdateAsync(T obj, DatabaseSource dbSource, bool skipCheck)
        {
            ISession session = BuildSession(obj.MFBCode, dbSource);
            ITransaction tran = BuildTransaction(session);
            try
        ...
        /// </summary>
        /// <param name="obj">The obj.</param>
        public async static Task UpdateAsync(T obj)
        {
            await UpdateAsync(obj, DatabaseSource.Local);
        }
        ...
        /// </summary>
        /// <param name="obj">The obj.</param>
        public async static Task UpdateAsync(T obj, bool skipCheck)
        {
            await UpdateAsync(obj, DatabaseSource.Local, skipCheck);
        }
        ...
        /// </summary>
        /// <param name="obj">The obj.</param>
        public async Task UpdateAsync(T obj, bool nonStatic = true, bool overLoad = true)
        {
            await UpdateAsync(obj, DatabaseSource.Local);
        }
        ...
        /// </summary>
        /// <param name="obj">The obj.</param>
        public static async Task SaveAsync(T obj, DatabaseSource dbSource)
        {
            ISession session = BuildSession(obj.MFBCode, dbSource);
            ITransaction tran = BuildTransaction(session);
            try
        ...
        /// </summary>
        /// <param name="obj">The obj.</param>
        public static async Task SaveAsync(T obj)
        {
            await SaveAsync(obj, DatabaseSource.Local);
        }
        ...
        /// </summary>
        /// <param name="obj">The obj.</param>
        public async Task SaveAsync(T obj, bool nonStatic = true)
        {
            await SaveAsync(obj, DatabaseSource.Local);
        }
        ...
        /// <param name="id">The id.</param>
        /// <returns></returns>
        public async static Task<T> RetrieveAsync(string mfbCode, idT id)
        {
            return await RetrieveAsync(mfbCode, id, DatabaseSource.Local);
        }
        ...
        /// <param name="id">The id.</param>
        /// <returns></returns>
        public async Task<T> RetrieveAsync(long id)
        {
            return await RetrieveAsync("", id, DatabaseSource.Local);
        }
        ...
        /// <param name="id">The id.</param>
        /// <returns></returns>
        public async static Task<T> RetrieveAsync(string mfbCode, idT id, DatabaseSource dbSource)
        {
            T result = default(T);
            ISession session = BuildSession(mfbCode, dbSource);
            try
        ...
        /// <param name="id">The id.</param>
        /// <returns></returns>
        public async static Task<T> RetrieveAsync(string mfbCode, long id, DatabaseSource dbSource)
        {
            T result = default(T);
            ISession session = BuildSession(mfbCode, dbSource);
            try
        ...
        public async static Task<List<T>> RetrieveAllAsync()
        {
        ...
        /// </summary>
        /// <returns></returns>
        public async static Task<List<T>> RetrieveAllAsync(string mfbCode)
        {
            return await RetrieveAllAsync(mfbCode, DatabaseSource.Local);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public async static Task<List<T>> RetrieveAllAsync(string mfbCode, DatabaseSource dbSource)
        {
            List<T> results = new List<T>();
            ISession session = BuildSession(mfbCode, dbSource);
            try
            {
                results = await session.CreateCriteria(typeof(T)).ListAsync<T>() as List<T>;
            }
            catch
            {
                throw;
        ...
        public static List<T> RetrieveAll(string mfbCode, int page, int pageSize, int totalItemsCount)
        {
            return RetrieveAll(mfbCode, page, pageSize, totalItemsCount);
        }
        ...
        /// <param name="pageSize">The size of the page the Grid/Data source needs.</param>
        /// <returns>A subset of a list of data.</returns>
        public async static Task<List<T>> RetrieveAllAsync(string mfbCode, int page, int pageSize, int totalItemsCount)
        {
            return await RetrieveAllAsync(mfbCode, page, pageSize, totalItemsCount);
        }
        ...
        /// <param name="pageSize">The size of the page the Grid/Data source needs.</param>
        /// <returns>A subset of a list of data.</returns>
        public async static Task<List<T>> RetrieveAllAsync(string mfbCode, int page, int pageSize, int totalItemsCount, DatabaseSource dbSource)
        {
            List<T> results = new List<T>();
            ...
            try
            {
                ...
                ISession s = BuildSession(mfbCode, dbSource);
                IList allResults = await s.CreateMultiCriteria()
                                    .Add(s.CreateCriteria(typeof(T)).SetFirstResult(page * pageSize).SetMaxResults(pageSize))
                                    .Add(s.CreateCriteria(typeof(T)).SetProjection(Projections.RowCountInt64()))
                                    .ListAsync();
        ...
        /// <param name="withDeleted">if set to <c>true</c> [with deleted].</param>
        /// <returns></returns>
        public async static Task<List<T>> RetrieveAllAsync(string mfbCode, bool withDeleted)
        {
            return await RetrieveAllAsync(mfbCode, withDeleted, DatabaseSource.Local);
        }
        ...
        /// <param name="withDeleted">if set to <c>true</c> [with deleted].</param>
        /// <returns></returns>
        public async static Task<List<T>> RetrieveAllAsync(string mfbCode, bool withDeleted, DatabaseSource dbSource)
        {
            List<T> results = new List<T>();
            ISession session = BuildSession(mfbCode, dbSource);
            try
            {
                ...
                {
                    results = await session.CreateCriteria(typeof(T)).Add(Expression.Eq("IsDeleted", false)).ListAsync<T>() as List<T>;
                }
            }
            catch
            {
        ...
        {
            CommitChanges("", DatabaseSource.Local);
        }

        /// <summary>
        /// Commits the changes.
        /// </summary>
        public async static Task CommitChangesAsync(string mfbCode)
        {
            await CommitChangesAsync(mfbCode, DatabaseSource.Local);
        }
        ...
        {
            await CommitChangesAsync("", DatabaseSource.Local);
        }
        ...
        /// Commits the changes(From Local/Remote DB).
        /// </summary>
        public async static Task CommitChangesAsync(string mfbCode, DatabaseSource dbSource)
        {
            ISession session = BuildSession(mfbCode, dbSource);
            if (session.Transaction != null && session.Transaction.IsActive)
            {
