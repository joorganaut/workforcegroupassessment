...
using AXAMansard.Framework.ISO8583.Client.DTO;
using AXAMansard.Framework.ISO8583.Client.Messages;
...
using AXAMansard.Framework.ISO8583.Client.Exceptions;
using AXAMansard.Framework.ISO8583.DTO;
using AXAMansard.Framework.ISO8583.DAO;


namespace AXAMansard.Framework.ISO8583.Client
{
    public class Engine
    {
        ...
        private Trx.Messaging.Message ProcessRequest(Iso8583Message msg)
        {
            ...
            msgLog.Message = AXAMansard.Framework.Utility.BinarySerializer.SerializeObject(msg.Fields);
            ...
            else
            {
                ...
                msgLog.ResponseMessage = AXAMansard.Framework.Utility.BinarySerializer.SerializeObject(clo.Fields);
